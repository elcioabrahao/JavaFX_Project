 ...
 * @author
 */
public class AddDevoteeController implements Initializable {
    
    final static Logger logger = Logger.getLogger(AddDevoteeController.class.getName());
    ...
    private void btnSaveOnAction(ActionEvent event) {
        ...
        if (tfError.getText().equalsIgnoreCase("")) {
            ...
            success = ddc.saveDevoteeDet(dd).isSuccessSave();
            ...
            if (success) {
                try {
                    ...
                    Logger.getLogger(AddDevoteeController.class.getName()).log(Level.FATAL, null, e);
                }
            }
        }
